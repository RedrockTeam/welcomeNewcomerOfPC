    ...
    <div class="activity">
        ...
        <div class="frame1">
            <div class="frame-in">
                ...
                <div class="right">
                    <p>想知道重邮校园的秘密？想和学长学姐零距离接触？热心的学长学姐都在这里，他们是重邮小百科，为你答疑解惑！</p>
        ...
        <div class="frame2">
            <div class="frame-in">
                ...
                <div class="right">
                    ...
                    <click-me class="button" path='/activity/smile'></click-me>
                </div>
            </div>
            <div class="controlbar2"></div>
        </div>
    </div>
</template>
...
<style lang="less" scoped>
    ...
    .title {
        ...
        width: 200px;
        height: 80px;
        background: url('../assets/home-activity-title.png') no-repeat;
    ...
    .frame1 {
        ...
        width: 1000px;
        height: 340px;
        background: url('../assets/home-long-frame1.png') no-repeat;
        background-size: 100% 100%;
        margin-top: 13px;
        position: relative;
        &:hover {
    ...
    .frame2 {
        ...
        width: 1000px;
        height: 340px;
        background: url('../assets/home-long-frame2.png') no-repeat;
        background-size: 100% 100%;
        margin-top: 70px;
        position: relative;
        &:hover {
