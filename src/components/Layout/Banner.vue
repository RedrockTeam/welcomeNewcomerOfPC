<template>
        <div class="banner">
            <img src="../../assets/cloud.png" alt="云" class="cloud animated shake">
            <div  class="robot">
                <img src="../../assets/robot-body.png" alt="机器人身体">
                <img src="../../assets/go.png" alt="go" class="go animated shake">
                ...
                <div class="time" v-on:click="daojishi">
...
<style lang="less" scoped>
        ...
        .time-font {
            width: 50%;
            height: 100%;
            background: url(../../assets/daojishi.png);
